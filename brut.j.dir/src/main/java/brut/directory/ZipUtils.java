...
public class ZipUtils {
    ...
    public static void zipFolders(final File folder, final File zip, final File assets, final Collection<String> doNotCompress, final int level, final AdditionalZipOperation additionalZipOperation)
